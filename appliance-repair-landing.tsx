      ...
      <main className="flex-1">
        ...
        <section className="w-full py-8 md:py-16 lg:py-24 xl:py-32 bg-gradient-to-br from-orange-50 to-orange-100">
          <div className="container px-4 md:px-6 max-w-6xl mx-auto">
            <div className="flex flex-col lg:flex-row items-center lg:items-stretch gap-6 lg:gap-12">
              {/* Text content */}
              <div className="order-2 lg:order-1 flex-1 flex flex-col justify-center space-y-4 w-full">
              ...
              {/* Image */}
              <div className="order-1 lg:order-2 w-full mb-6 lg:mb-0 lg:w-[600px] flex-shrink-0 flex justify-center items-center">
                <Image
